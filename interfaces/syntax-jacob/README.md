...
- Astronomy truth layer: JPL Horizons Cartesian state vectors and JPL SBDB orbital metadata, refreshed at runtime through the public `city-app-host/syntax-jacob-ephemeris` server route so the browser does not embed NASA/JPL SSD APIs directly.
